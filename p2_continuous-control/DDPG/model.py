...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fcs1_units=256, fc2_units=256, fc3_units=128 ):   #fc3_units=128
        ...
        self.fc3 = nn.Linear(fc2_units, fc3_units)  #3 Layers Mode
        self.fc4 = nn.Linear(fc3_units, 1)          #3 Layers Mode
        #self.fc3 = nn.Linear(fc2_units, 1)    # 2 Layers Mode
        self.reset_parameters()
    ...
    def forward(self, state, action):
        ...
        x = F.relu(self.fc2(x))
        x = F.relu(self.fc3(x))  #3 Layers Mode
        return self.fc4(x)      #3 Layers Mode
        # return self.fc3(x)   # 2 Layers Mode
