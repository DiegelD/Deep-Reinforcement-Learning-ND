...
![equation](https://latex.codecogs.com/gif.image?\dpi{100}&space;\left&space;(S,&space;A,r(s_{t},a_{t}),P(s_{t&plus;1}|s_{t},a_{t}),\gamma&space;&space;\right&space;)&space;" title="\left (S, A,r(s_{t},a_{t}),P(s_{t+1}|s_{t},a_{t}),\gamma \right ))
