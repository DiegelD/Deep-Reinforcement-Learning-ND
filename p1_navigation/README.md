...
At time step *t*, the agent selects the action ![equation](https://latex.codecogs.com/gif.image?\dpi{110}&space;a_{t}\in&space;A) by following a police
![equation](https://latex.codecogs.com/gif.image?\dpi{110}&space;\pi&space;:&space;S\rightarrow&space;\mathbb{R})
